...
base64 = Base64.encode64(deflated2).gsub(/\n/, '')
url_encoded = URI.encode_www_form_component(base64)

puts '[+] Encoding result'
pp url_encoded
# pp Base64.strict_encode64(URI.encode_www_form_component(deflated2))
